...
var CONFIG = {
  ...
  HEADERS: {
    ...
    MULTI_NOTA: [
      'NO_TRANSAKSI', 'URUTAN', 'NAMA_PENYEDIA', 'NPWP_PENYEDIA', 'ALAMAT_PENYEDIA',
      'NO_NOTA', 'TGL_NOTA', 'NILAI', 'KETERANGAN', 'FILE_ID', 'NAMA_FILE', 'URL_FILE',
    ...
    PENGEMBALIAN: [
      'NO_TRANSAKSI', 'URUTAN', 'TANGGAL', 'NILAI', 'KETERANGAN', 'REF_MASUK_NO',
      'CREATED_AT', 'IS_DELETED', 'DELETED_AT', 'DELETED_BY'
    ],
    FOTO_BARANG: [
