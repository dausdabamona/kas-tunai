...
var CONFIG = {
  ...
  PAJAK_REF: [
    ...
    { label:'Sewa Kapal',
      ...
      mapPPh:'411124', kjsPPh:'104', minPPh:0, minPPN:2000000,
      catatan:'' },
    ...
    { label:'Sewa Gedung / Ruangan',
      ...
      mapPPh:'411128', kjsPPh:'403', minPPh:0, minPPN:2000000,
    ...
    { label:'Perencanaan / Pengawasan Konstruksi',
      ...
      mapPPh:'411128', kjsPPh:'409', minPPh:0, minPPN:2000000,
    ...
    { label:'ATK / Alat Tulis',
      ...
      mapPPh:'411122', kjsPPh:'910', minPPh:2000000, minPPN:2000000,
